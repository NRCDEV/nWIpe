...
AddEventHandler("nWipe:wipePlayer", function(target)
    ...
    DropPlayer(target, "[nWipe] - Vous avez été wipe...")
    TriggerClientEvent("esx:showNotification", _src, "~g~Wipe effectuer")

    local w = {{ ["author"] = { ["name"] = "🪐 nWipe", ["icon_url"] = "https://cdn.discordapp.com/attachments/886646425243517028/946471181744222279/logo_nrcShop2.png" }, ["color"] = "10038562", ["title"] = Title, ["description"] = "**Nouveau wipe :**\n\n**Staff :** ``"..xPlayer.getName().."``\n**Joueur :** ``"..xTarget.getName().."``", ["footer"] = { ["text"] = "🪐 "..os.date("%d/%m/%Y | %X"), ["icon_url"] = nil}, } }
